...
<!----- Form starts ---------------------------------------------------------->
	<form id="form_1" enctype="multipart/form-data" class="frmImageUpload"  method="post" action="students22.php" style="border: solid 2px #40a0c0">
		
	<img src="images/list_header.jpg" alt="icon" width="530" height="85" border="0" align="left"/>
	<img id="blah" src="#" alt=" " />
<ul>
<li id="li_1" >
...
<td>   <label class="description" for="class_list">Class </label> <select class="element select large" id="class" name="class"  required> 
			<option value="" selected="selected"></option>
			<option value="FYCO" >First Year</option>
			<option value="SYCO" >Second Year</option>
			<option value="TYCO" >Third Year</option>
		</select> </td>
		<TD> <label class="description" for="acad">Displays List of Active Students, Registered for current Semester </label> </td>
		<td>     </td>
</tr>
<tr>
...
<tr>
 <td><input type="hidden" name="form_id" value="922864" /></td>
	<td>	<input id="submit" class="button_text" type="submit" name="submit" value="Submit  Form" />&nbsp;&nbsp;&nbsp;
	        <input type='reset' value='Clear  Form' name='reset'>     </td>
	<td>	</td>
 </tr>
