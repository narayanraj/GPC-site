   ...
   <div class="header" >
      ...
      <div class="">
		<ul id="css3menu1" class="topmenu">
			...
			<li class="topmenu"><a href="stud_view.php" style="height:15px;line-height:15px;">Student-view</a></li>
			<li class="topmenu"><a href="stud_view_search.php" style="height:15px;line-height:15px;">Student-search</a></li>
			<li class="topmenu"><a href="stud_edit.php" style="height:15px;line-height:15px;">Student-Edit</a></li>
...
<!----- Form starts ---------------------------------------------------------->
	<form id="form_1" align="right" enctype="multipart/form-data" class="frmImageUpload"  method="post" action="output_dte22.php" style="border: solid 2px #40a0c0">
		
	<img src="images/Result_header.jpg" alt="icon" width="530" height="85" border="0" align="left"/>
	<img id="blah" src="#" alt=" " />
<ul>
<li id="li_1" >
...
<input type="text" id="rollno" name= "rollno" class="element text medium" pattern=".{6,6}" maxlength="6" value=""   onkeypress="return isRollnoKey(event)" required/> 
</td>   <!---  <input type="text" name="rollno" maxlength="15"/></td>   -->

<td><label class="description" for="regno">Registration Num. </label>
<input type="text" id="regno" name="regno" class="element text medium" pattern=".{9,9}" maxlength="9" value="" type="text"   onkeypress="return isNumberKey(event)" readonly/> </td>

<TD> <label class="description" for="acad">Displays BTE Semester Exam Result</br>for a given ROLLNO </label> </td>
</tr>
<tr>
