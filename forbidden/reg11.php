...
<!----- Form starts ---------------------------------------------------------->
	<form id="form_1" enctype="multipart/form-data" class="frmImageUpload"  method="POST" action="register22.php" style="border: solid 2px #40a0c0">
...
<td><label class="description" for="mname">Acad-Year </label> <input id="year" name= "year" class="element text" maxlength="15" size="15" value="2015-16" readonly/></td>
 ...
 <tr>
 <td><label class="description" for="dept_list">Department </label> <select class="element select medium" id="dept" name="dept" required> 
			<option value="" selected="selected"></option>
