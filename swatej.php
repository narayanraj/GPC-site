...
<div class="main" >
  <div class="main_resize" >
    ...
    <div class="slider_main">
      ...
      <p  align="justify" style=" position: relative; font-size: 10pt"><strong> Mr. Swatej Dessai<br /> 
	  Lecturer in Computer Engineering</strong><br/> <br/>
		  ...
		  ------------------------------------Put  upload documents here------------------------------------------------------>
			...
			<a href="downloads/swatej/Upload_dccn_diagrams.pdf" target="_blank">&#187; Pictures - Bounded Cable, Network devices, Topology </a>  
			<br />
