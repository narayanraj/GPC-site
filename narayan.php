...
<div class="main" >
  <div class="main_resize" >
	 ...
	 <div style="float:left;"><img src="images/comp_eng_logo.jpg" alt="icon" width="145" height="145" border="0" /></a></div>
      ...
      <div class="">
		<ul id="css3menu1" class="topmenu">
			...
			<li class="topmenu"><a class="pressed" style="height:15px;line-height:15px;"><span>Faculty Corner</span></a>
    ...
    <div class="slider_main">
      ...
      <!--  
	  <img src="images/nmr.jpg" alt="picture" width="300" height="225" class="floated" style="left: 0; position: relative; top: 0;" /><br />  -->
      <p  align="justify" style=" position: relative; font-size: 10pt"><strong> Mr. Narayan Rajadhyax<br /> 
	  Lecturer in Computer Engineering</strong><br/> <br/>
	 
	  	  
		  <!----------------------------------------------------------------------------------------------------------------
		  ------------------------------------Put  upload documents here------------------------------------------------------>
		  
			<a href="downloads/narayan/Upload_dccn_diagrams.pdf" target="_blank">&#187; Pictures - Bounded Cable, Network devices, Topology </a>  
			<br /> <br />
			<a href="downloads/narayan/scilab_intro.pdf" target="_blank">&#187; Introduction to Scilab software - Manual </a>  
			<br />
